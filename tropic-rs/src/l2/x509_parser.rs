...
// impl<'a> fmt::Display for AttributeTypeAndValue<'a> {
//     fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
//         let name_str = get_der_oid(self.oid);

//         let value = match name_str {
//             Some("C") => {
//                 let printable_string = der::asn1::PrintableStringRef::try_from(self.value).unwrap();
...
// impl<'a> fmt::Display for Validity<'a> {
//     fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
/// The TBSCertificate structure from RFC 5280.
#[derive(Clone, Debug, Eq, PartialEq, Sequence)]
...
// impl<'a> fmt::Display for TbsCertificate<'a> {
//     fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
//         writeln_lf!(
//             f,
//             "        Version: {} ({:x})",
...
// impl<'a> fmt::Display for Certificate<'a> {
//     fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
