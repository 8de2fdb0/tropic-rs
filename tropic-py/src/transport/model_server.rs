...
use tropic_rs::{l1, transport::spi};
...
const LT_L1_LEN_MAX: usize = l1::LEN_MAX;
...
impl spi::Error for Error {
    fn kind(&self) -> spi::ErrorKind {
        match self {
            ...
            Error::Protocol(_) => spi::ErrorKind::Other,
            Error::TagMismatch(_, _) => spi::ErrorKind::Other,
            Error::InvalidResponseTag(_) => spi::ErrorKind::Other,
            Error::UnsupportedTag(_) => spi::ErrorKind::Other,
            Error::DataLenMismatch => spi::ErrorKind::Other,
        }
    }
}
...
impl TcpTransport {
    ...
    pub fn connect(ip: IpAddr, port: u16) -> Result<Self, Error> {
...
impl spi::ErrorType for TcpTransport {
    type Error = Error;
}

impl spi::SpiDevice for TcpTransport {
    fn transaction(
        &mut self,
